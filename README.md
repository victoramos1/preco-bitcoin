<h1>Projeto: Preço do Bitcoin</h1>

![App em funcionamento](imagens/preco-bitcoin.gif)

<h2>Descrição do projeto</h2>

<p>O projeto consiste em mostrar o preço do Bitcoin.</p>

<h2>Funcionalidades do projeto</h2>

<p>O projeto consiste em mostrar o preço do Bitcoin ao clicar no botão desginado.</p>
...
<p>2 - Utilize o comando <code>git clone https://github.com/victoramos1/preco-bitcoin</code> caso tenha o Git instalado no computador, ou faça o download do arquivo .zip diretamente do GitHub e descompacte em um local.</p>
